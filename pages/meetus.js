...
const CardContent = styled.div`
  ...
  .position {
    ${tw`uppercase font-bold tracking-widest text-xs text-green-700`}
  }
  .name {
...
const CardLinks = styled.div`
  ${tw`mt-6 flex`}
  .link {
    ${tw`mr-8 last:mr-0 text-gray-400 hocus:text-green-700 transition duration-300`}
    .icon {
...
export default ({
  heading = "Your hosts for tonight..",
  subheading = "",
  description = "",
  cards = [
    {
      ...
      links: [
        {
          url: "https://www.linkedin.com/in/dajanadamjanovic/",
          icon: LinkedinIcon,
        },
      ],
    },
    {
      ...
      links: [
        {
          url: "https://www.linkedin.com/in/markovujic/",
          icon: LinkedinIcon,
        },
      ],
    }
