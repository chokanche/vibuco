...
import backimage from "../../images/home-background.jpg"
...
`;
const Testimonial = tw.div`max-w-sm rounded-b md:rounded-none relative sm:absolute bottom-0 inset-x-0 z-20 px-8 py-6 sm:px-10 sm:py-8 bg-green-800 text-gray-400 font-medium transform md:-translate-x-32 text-sm leading-none md:-mr-16 xl:mr-0`
...
export default ({
  heading = "Unpack your Thoughts",
  description = "Ask your client to choose one card they would like to flip. When they pick a card you start with questioning what comes to their mind when they see a photo. After the first idea, you explore more with your client by asking them open questions about how this first idea is connected with their current situation or challenges.",
  imageSrc = backimage,
  imageDecoratorBlob = true,
  primaryButtonUrl = "https://google.com",
  primaryButtonText = "Get Started",
  buttonRounded = true,
  features = ["Available for free for a limited time.", "Change your perspective.", "Make it digital."],
  testimonial = {
